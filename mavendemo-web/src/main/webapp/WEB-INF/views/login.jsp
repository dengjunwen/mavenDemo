...
<head>
	...
	<!-- STYLESHEETS --><!--[if lt IE 9]><script src="${path}/js/flot/excanvas.min.js"></script><script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script><script src="http://css3-mediaqueries-js.googlecode.com/svn/trunk/css3-mediaqueries.js"></script><![endif]-->
	...
	<!-- UNIFORM -->
	<link rel="stylesheet" type="text/css" href="${path}/js/uniform/css/uniform.default.min.css" />
	<!-- ANIMATE -->
...
<body class="login">	
				...
				<div class="container">
					<div class="row">
						<div class="col-md-4 col-md-offset-4">
							<div id="logo">
								<a href="index.html"><img src="${path}/img/logo/logo-alt.png" height="40" alt="logo name" /></a>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="login-box-plain">
								...
								<form id="loginform" role="form"  method="post">
								  ...
								  <div class="form-actions">
									<label class="checkbox"><input type="checkbox" name="remeberMe" class="uniform" value="">记住我</label>
									<button type="button"  id="login_btn" class="btn btn-danger">登陆</button>
								  </div>
								</form>
								<!-- /SOCIAL LOGIN -->
	...
	<!-- BOOTBOX -->
	<script type="text/javascript" src="${path}/js/bootbox/bootbox.min.js"></script>
	<!-- UNIFORM -->
	<script type="text/javascript" src="${path}/js/uniform/jquery.uniform.min.js"></script>
	<!-- CUSTOM SCRIPT -->
	...
	<script type="text/javascript">
		function swapScreen(id) {
			...
			location.href="${path}/manage/index";
		}
	</script>
	<!-- /JAVASCRIPTS -->
</body>
