...
$.device = function(a) {
    ...
    return b.statusBar ? k.push("with-statusbar-overlay") : a("html").removeClass("with-statusbar-overlay"),
...
function(a) {
    ...
    a.popup = function(b, c) {
        ...
        return b = a(b),
        0 === b.length ? !1 : (b.show(), b.find(".content").scroller("refresh"), b.find("." + e.viewClass).length > 0 && a.sizeNavbars(b.find("." + e.viewClass)[0]), a.openModal(b), b[0])
    },
...
function(a) {
    ...
    c = function(c) {
        ...
        function i() {
            j.opened = !1,
            j.input && j.input.length > 0 && j.input.parents(".page-content").css({
                "padding-bottom": ""
            }),
            j.params.onClose && j.params.onClose(j),
            j.destroyCalendarEvents()
        }
        var j = this,
        k = {
        ...
        j.params = c,
        j.initialized = !1,
        j.inline = j.params.container ? !0 : !1,
        j.isH = "horizontal" === j.params.direction;
        var m = j.isH && b ? -1 : 1;
        return j.animating = !1,
        j.addValue = function(a) {
            if (j.params.multiple) {
                ...
                "undefined" == typeof b ? j.value.push(a) : j.value.splice(b, 1),
                j.updateValue()
            } else j.value = [a],
            j.updateValue()
        },
        ...
        j.initCalendarEvents = function() {
            ...
            function d(a) {
                if (g) {
                    ...
                    x = !1,
                    h || (h = !0, s = j.wrapper[0].offsetWidth, t = j.wrapper[0].offsetHeight, j.wrapper.transition(0)),
                    a.preventDefault(),
                    v = j.isH ? l - i: n - k,
                    u = v / (j.isH ? s: t),
                    r = 100 * (j.monthsTranslate * m + u),
                    j.wrapper.transform("translate3d(" + (j.isH ? r: 0) + "%, " + (j.isH ? 0 : r) + "%, 0)")
                }
            }
            function e(a) {
            ...
            function f(b) {
                if (x) {
                    ...
                    if (0 === c.length && a(b.target).hasClass("picker-calendar-day") && (c = a(b.target)), 0 !== c.length && (!c.hasClass("picker-calendar-day-selected") || j.params.multiple) && !c.hasClass("picker-calendar-day-disabled")) {
                        c.hasClass("picker-calendar-day-next") && j.nextMonth(),
                        c.hasClass("picker-calendar-day-prev") && j.prevMonth();
                        var d = c.attr("data-year"),
                        e = c.attr("data-month"),
                        f = c.attr("data-day");
                        j.params.onDayClick && j.params.onDayClick(j, c[0], d, e, f),
                        j.addValue(new Date(d, e, f).getTime()),
                        j.params.closeOnSelect && j.close()
                    }
                }
            }
            var g, h, i, k, l, n, o, p, q, r, s, t, u, v, w, x = !0;
            j.container.find(".picker-calendar-prev-month").on("click", j.prevMonth),
            j.container.find(".picker-calendar-next-month").on("click", j.nextMonth),
            j.container.find(".picker-calendar-prev-year").on("click", j.prevYear),
            j.container.find(".picker-calendar-next-year").on("click", j.nextYear),
            j.wrapper.on("click", f),
            j.params.touchMove && (j.wrapper.on(a.touchEvents.start, c), j.wrapper.on(a.touchEvents.move, d), j.wrapper.on(a.touchEvents.end, e)),
            j.container[0].f7DestroyCalendarEvents = function() {
                j.container.find(".picker-calendar-prev-month").off("click", j.prevMonth),
                j.container.find(".picker-calendar-next-month").off("click", j.nextMonth),
                j.container.find(".picker-calendar-prev-year").off("click", j.prevYear),
                j.container.find(".picker-calendar-next-year").off("click", j.nextYear),
                j.wrapper.off("click", f),
                j.params.touchMove && (j.wrapper.off(a.touchEvents.start, c), j.wrapper.off(a.touchEvents.move, d), j.wrapper.off(a.touchEvents.end, e))
            }
        },
        ...
        j.monthHTML = function(a, b) {
            ...
            if (j.value && j.value.length) for (i = 0; i < j.value.length; i++) l.push(new Date(j.value[i]).setHours(0, 0, 0, 0));
            for (i = 1; m >= i; i++) {
                var t = "";
                for (k = 1; n >= k; k++) {
                    var u = k;
                    ...
                    j.params.weekendDays.indexOf(u - 1) >= 0 && (w += " picker-calendar-day-weekend"),
        ...
        j.animating = !1,
        j.updateCurrentMonthYear = function(a) {
            "undefined" == typeof a ? (j.currentMonth = parseInt(j.months.eq(1).attr("data-month"), 10), j.currentYear = parseInt(j.months.eq(1).attr("data-year"), 10)) : (j.currentMonth = parseInt(j.months.eq("next" === a ? j.months.length - 1 : 0).attr("data-month"), 10), j.currentYear = parseInt(j.months.eq("next" === a ? j.months.length - 1 : 0).attr("data-year"), 10)),
            j.container.find(".current-month-value").text(j.params.monthNames[j.currentMonth]),
            j.container.find(".current-year-value").text(j.currentYear)
        },
        j.onMonthChangeStart = function(a) {
            j.updateCurrentMonthYear(a),
            j.months.removeClass("picker-calendar-month-current picker-calendar-month-prev picker-calendar-month-next");
            var b = "next" === a ? j.months.length - 1 : 0;
            j.months.eq(b).addClass("picker-calendar-month-current"),
            j.months.eq("next" === a ? b - 1 : b + 1).addClass("next" === a ? "picker-calendar-month-prev": "picker-calendar-month-next"),
            j.params.onMonthYearChangeStart && j.params.onMonthYearChangeStart(j, j.currentYear, j.currentMonth)
        },
        j.onMonthChangeEnd = function(a, b) {
            j.animating = !1;
            var c, d, e;
            j.wrapper.find(".picker-calendar-month:not(.picker-calendar-month-prev):not(.picker-calendar-month-current):not(.picker-calendar-month-next)").remove(),
            "undefined" == typeof a && (a = "next", b = !0),
            b ? (j.wrapper.find(".picker-calendar-month-next, .picker-calendar-month-prev").remove(), d = j.monthHTML(new Date(j.currentYear, j.currentMonth), "prev"), c = j.monthHTML(new Date(j.currentYear, j.currentMonth), "next")) : e = j.monthHTML(new Date(j.currentYear, j.currentMonth), a),
            ("next" === a || b) && j.wrapper.append(e || c),
            ("prev" === a || b) && j.wrapper.prepend(e || d),
            j.months = j.wrapper.find(".picker-calendar-month"),
            j.setMonthsTranslate(j.monthsTranslate),
            j.params.onMonthAdd && j.params.onMonthAdd(j, "next" === a ? j.months.eq(j.months.length - 1)[0] : j.months.eq(0)[0]),
            j.params.onMonthYearChangeEnd && j.params.onMonthYearChangeEnd(j, j.currentYear, j.currentMonth)
        },
        j.setMonthsTranslate = function(a) {
            a = a || j.monthsTranslate || 0,
            "undefined" == typeof j.monthsTranslate && (j.monthsTranslate = a),
            j.months.removeClass("picker-calendar-month-current picker-calendar-month-prev picker-calendar-month-next");
            var b = 100 * -(a + 1) * m,
            c = 100 * -a * m,
            d = 100 * -(a - 1) * m;
            j.months.eq(0).transform("translate3d(" + (j.isH ? b: 0) + "%, " + (j.isH ? 0 : b) + "%, 0)").addClass("picker-calendar-month-prev"),
            j.months.eq(1).transform("translate3d(" + (j.isH ? c: 0) + "%, " + (j.isH ? 0 : c) + "%, 0)").addClass("picker-calendar-month-current"),
            j.months.eq(2).transform("translate3d(" + (j.isH ? d: 0) + "%, " + (j.isH ? 0 : d) + "%, 0)").addClass("picker-calendar-month-next")
        },
        j.nextMonth = function(b) { ("undefined" == typeof b || "object" == typeof b) && (b = "", j.params.animate || (b = 0));
            ...
            if (j.monthsTranslate--, c === j.currentMonth) {
                ...
                j.wrapper.append(i[0]),
                j.months = j.wrapper.find(".picker-calendar-month"),
                j.params.onMonthAdd && j.params.onMonthAdd(j, j.months.eq(j.months.length - 1)[0])
            }
            j.animating = !0,
            j.onMonthChangeStart("next");
            var k = 100 * j.monthsTranslate * m;
            j.wrapper.transition(b).transform("translate3d(" + (j.isH ? k: 0) + "%, " + (j.isH ? 0 : k) + "%, 0)"),
            g && j.wrapper.transitionEnd(function() {
                j.onMonthChangeEnd("next")
            }),
            j.params.animate || j.onMonthChangeEnd("next")
        },
        j.prevMonth = function(b) { ("undefined" == typeof b || "object" == typeof b) && (b = "", j.params.animate || (b = 0));
            ...
            if (j.monthsTranslate++, c === j.currentMonth) {
                ...
                j.wrapper.prepend(i[0]),
                j.months = j.wrapper.find(".picker-calendar-month"),
                j.params.onMonthAdd && j.params.onMonthAdd(j, j.months.eq(0)[0])
            }
            j.animating = !0,
            j.onMonthChangeStart("prev");
            var k = 100 * j.monthsTranslate * m;
            j.wrapper.transition(b).transform("translate3d(" + (j.isH ? k: 0) + "%, " + (j.isH ? 0 : k) + "%, 0)"),
            g && j.wrapper.transitionEnd(function() {
        ...
        j.setYearMonth = function(a, b, c) {
            "undefined" == typeof a && (a = j.currentYear),
            "undefined" == typeof b && (b = j.currentMonth),
            ("undefined" == typeof c || "object" == typeof c) && (c = "", j.params.animate || (c = 0));
            var d;
        ...
        j.layout = function() {
            ...
            j.params.toolbar && (m = j.params.toolbarTemplate.replace(/{{closeText}}/g, j.params.toolbarCloseText).replace(/{{monthPicker}}/g, j.params.monthPicker ? j.params.monthPickerTemplate: "").replace(/{{yearPicker}}/g, j.params.yearPicker ? j.params.yearPickerTemplate: "")),
            b = '<div class="' + c + '">' + m + '<div class="picker-modal-inner">' + i + h + "</div></div>",
            j.pickerHTML = b
        },
        j.params.input && (j.input = a(j.params.input), j.input.length > 0 && (j.params.inputReadOnly && j.input.prop("readOnly", !0), j.inline || j.input.on("click", g), j.params.inputReadOnly && j.input.on("focus mousedown",
        function(a) {
            a.preventDefault()
        }))),
        j.inline || a("html").on("click", h),
        j.opened = !1,
        j.open = function() {
            var b = d(),
            c = !1;
            j.opened || (j.value || j.params.value && (j.value = j.params.value, c = !0), j.layout(), b ? (j.pickerHTML = '<div class="popover popover-picker-calendar"><div class="popover-inner">' + j.pickerHTML + "</div></div>", j.popover = a.popover(j.pickerHTML, j.params.input, !0), j.container = a(j.popover).find(".picker-modal"), a(j.popover).on("close",
            function() {
                i()
            })) : j.inline ? (j.container = a(j.pickerHTML), j.container.addClass("picker-modal-inline"), a(j.params.container).append(j.container)) : (j.container = a(a.pickerModal(j.pickerHTML)), a(j.container).on("close",
            function() {
                i()
            })), j.container[0].f7Calendar = j, j.wrapper = j.container.find(".picker-calendar-months-wrapper"), j.months = j.wrapper.find(".picker-calendar-month"), j.updateCurrentMonthYear(), j.monthsTranslate = 0, j.setMonthsTranslate(), j.initCalendarEvents(), c && j.updateValue()),
            j.opened = !0,
            j.initialized = !0,
            j.params.onMonthAdd && j.months.each(function() {
        ...
        j.destroy = function() {
            j.close(),
            j.params.input && j.input.length > 0 && j.input.off("click focus", g),
            a("html").off("click", h)
        },
        j.inline && j.open(),
        j
...
function(a) {
    ...
    function b(b) {
        ...
        return this.each(function() {
            ...
            h = f.data("scroller");
            return h || f.data("scroller", h = new e(this, g)),
            "string" == typeof b && "function" == typeof h[b] && (d = h[b].apply(h, c), void 0 !== d) ? !1 : void 0
        }),
        void 0 !== d ? d: this
    }
    var c = function(a, b) {
    ...
    var e = function(b, d) {
        ...
        if (g) {
            ...
            j && (k.ptr = !0, k.ptrOffset = 44),
            this.scroller = new IScroll(b, k),
    ...
    var f = a.fn.scroller;
    a.fn.scroller = b,
    a.fn.scroller.Constructor = e,
    a.fn.scroller.noConflict = function() {
        return a.fn.scroller = f,
        this
    },
    a(function() {
...
function(a) {
    ...
    b.prototype.init = function() {
        ...
        if (!e) {
            ...
            this.pushState(location.href, f),
            this.pushBack({
                url: location.href,
                pageid: b[0].id,
                id: f
    ...
    b.prototype.animatePages = function(a, b, c) {
        ...
        c ? (a.trigger("pageAnimationStart", [b[0].id, b]), a.removeClass(d).addClass("page-from-left-to-center"), b.removeClass(d).addClass("page-from-center-to-right"), a.animationEnd(function() {
            a.removeClass(d).addClass("page-current"),
            ...
            b.removeClass(d).addClass("page-current"),
    ...
    b.prototype.getPage = function(b, c) {
        ...
        this.xhr && this.xhr.readyState < 4 && (xhr.onreadystatechange = noop, xhr.abort(), this.dispatch("pageLoadCancel"));
        var d = this;
        this.xhr = a.ajax({
            url: b,
